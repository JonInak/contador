$(document).delegate('#ptve', 'pagecreate', function() {
	var dom = {
		"trabajos" : function(arraytrabajos, arraytrabajossub) {
			...
			for (i in arraytrabajos) {
				...
				if (arraytrabajos[i].codigo[0] != "A") {
					...
					//var visado = "<td class=\"textoizda\"><a id=\"wvisado" + arraytrabajos[i].id + "\" href=\"#popupvisado\" data-rel=\"popup\" data-position-to=\"window\" class=\"\" data-transition=\"pop\">" + arraytrabajos[i].visado + "</a></td>";
