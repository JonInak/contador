...
$trabajofuera_ = $_POST['trabajofuera'];
...
$trabajofuera =  utf8_decode($trabajofuera_);
...
mysqli_query($con, "INSERT INTO tb_horas (ID_HORAS, USUARIO, FECHA, PROYECTO, FASE, HORAS, DETALLE, BOLSA, FUERA, CODIGO_INAK)
VALUES ('{$trabajoid}','{$trabajousuario}', '{$trabajofecha}', '{$trabajoproyecto}', '{$trabajofase}', '{$trabajohoras}', '{$trabajodetalle}', '{$trabajohorasbolsa}','{$trabajofuera}', '{$trabajocodigo}')");
