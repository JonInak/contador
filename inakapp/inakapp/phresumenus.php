    					...
    					<!-- / <form class="popupwsmenu">
        					<div style="padding:10px 20px;">
            					...
            					<fieldset id="asignadoa" data-role="controlgroup">
        							...
        							<label for="ainhoa">Ainhoa</label>
        							<input type="checkbox" name="jose" id="jose">
        							<label for="jose">Jose</label>
									<input type="checkbox" name="eli" id="eli">
        							<label for="eli">Eli</label>
    							</fieldset>     					
            					<button id="popupasignadoaboton" type="button" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-btn-icon-left ui-icon-check">Aceptar</button>
        					</div>
    					</form> -->
			</div>
				...
				<div id="tablasmeses">
					<table id="phresumentable" >
						<tr>
							...
							<th colspan = "3" class="dcha"> Horas Teóricas: </th>
							<th colspan = "3" id="horasteoricasurte"> horas </th>
							<th colspan = "3" id="horasteoricasurtecomentario"> ... </th>
							<th colspan = "3" class="dcha">Horas Vacaciones: </th>
							<th colspan = "3" id="vacacionessindisfrutar"> ... </th>
							
						</tr>
						<tr>
							<th colspan = "3" class="dcha"> Horas Teóricas Hoy: </th>
							<th colspan = "3" id="horascalendariourtehoy" class='teoricashoy'> horas </th>
							<th colspan = "3" id="horascalendariourtehoycomentario" class='teoricashoy'> Horas Teóricas + Horas Vacaciones </th>
							<th colspan = "3" class="dcha">Horas Vacaciones Disfrutadas: </th>
							<th colspan = "3" id="vacacionesdisfrutadas"></th>
						</tr>
						<tr>
							<th colspan = "3" class="dcha"> Horas Reales: </th>
							...
							<th colspan = "3" class="dcha">Horas Baja: </th>
							<th colspan = "3" id="baja"> ... </th>
						</tr>
						<tr>
							<th colspan = "3" class="dcha"> Horas Bolsa: </th>
