...
<html>
	...
	<body>
		...
		?>
			...
			if ($_SESSION['usuario'] =="eli" | $_SESSION['usuario'] =="jon" | $_SESSION['usuario'] =="esti"| $_SESSION['usuario'] =="unai" | $_SESSION['usuario'] =="jose"| $_SESSION['usuario'] =="marcos" | $_SESSION['usuario'] =="markel" | $_SESSION['usuario'] =="andoni" | $_SESSION['usuario'] =="ziortza"| $_SESSION['usuario'] =="cris"| $_SESSION['usuario'] =="inigo" | $_SESSION['usuario'] =="izaskun"| $_SESSION['usuario'] =="alaitz"| $_SESSION['usuario'] =="joanes"| $_SESSION['usuario'] =="ainhoa"| $_SESSION['usuario'] =="andres"| $_SESSION['usuario'] =="cristina"| $_SESSION['usuario'] =="mikelrankin"| $_SESSION['usuario'] =="carolinauchuari"| $_SESSION['usuario'] =="inigoflorindo"){
				?>
				<html>
			<head>
