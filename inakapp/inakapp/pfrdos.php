		...
		<div data-role="page" id="pfrdos" >
			...
			<div data-role="content" class="anchocontenidodesktop">
				...
				<div id="ptcabecera">
					...
					<div data-role="popup" id="popupiva"  class="ui-corner-all">
    					<form class="popupwsmenu">
        					<div style="padding:10px 20px;">
            					<h3>IVA</h3>
            					<input type="text" id="modiva" value="" placeholder="IVA" >
            					<button id="popupivaboton" type="button" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-btn-icon-left ui-icon-check">Guardar</button>
        					</div>
    					</form>
					</div>
