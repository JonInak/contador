$(document).delegate('#pstdosh', 'pagecreate', function() {
    var dom = {
        "trabajos": function() {
            ...
            for (j in pst_arraytrabajos) {
                ...
                if ((pst_arraytrabajos[j].horas != 0) && (pst_arraytrabajos[j].codigo[0] != "A")) {
                    ...
                    var celdacodigo = "<th class=\"textoizda " + fila + "\"><a  href=\"ptidosh.php\"  id=\"" + pst_arraytrabajos[j].alias + "\">" + pst_arraytrabajos[j].codigo + "</a></th>";
                    ...
                    var celdasreplanteo = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasreplanteo + "</th>";
                    var celdasdelineacion = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasdelineacion + "</th>";
                    var celdascalculo = "<th class=" + fila + ">" + pst_arraytrabajos[j].horascalculo + "</th>";
                    var celdasrevision = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasrevision + "</th>";
                    var celdasmodificacionobra = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasmodificacionobra + "</th>";
                    var celdasasistenciaobra = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasasistenciaobra + "</th>";
                    var celdasmediciones = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasmediciones + "</th>";
                    var celdasotros = "<th class=" + fila + ">" + pst_arraytrabajos[j].horasotros + "</th>";
                    ...
                    var celdas = celdacodigo + celdaalias + celdacliente + celdasreplanteo + celdasdelineacion + celdascalculo + celdasrevision + celdasasistenciaobra + celdasmediciones + celdasotros;
