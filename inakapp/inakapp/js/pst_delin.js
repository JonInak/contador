$(document).delegate('#pstdelin', 'pagecreate', function() {
	var dom = {
		"tabla" : function(tipo, viviendas) {			
			...
			for (j in pst_arrayfasesdelin){
				filaini = filaini + "<th class='black'>"+pst_arrayfasesdelin[j].replace("Del-","")+"</th>"
			}
			filaini = "<tr><th class='black'>TRABAJO</th>"+filaini+"<th class='black'>HORAS</th></tr>"
			$("#psttabledelin").append("<tr><th>.</th></tr>");
			$("#psttabledelin").append("<tr><th class='black' colspan="+pst_arrayfasesdelin.length+2+">"+tipo+"</th></tr>");
			$("#psttabledelin").append("<tr><th class='black' colspan="+pst_arrayfasesdelin.length+2+">"+viviendas+"</th></tr>");
			$("#psttabledelin").append(filaini);
			for (i in pst_arraytrabajosdelin){
				fila = ""
				if ((pst_arraytrabajosdelin[i].tipo==tipo)&&(pst_arraytrabajosdelin[i].viviendas.replace("<","&lt").substring(2, pst_arraytrabajosdelin[i].length)==viviendas)){
				...
				fila = "<tr><th class='grisgrande'>" + pst_arraytrabajosdelin[i].alias + "</th>" + fila+ "<th  class='black'>"+pst_arraytrabajosdelin[i].sumahorastrabajo+"</th></tr>"
