	...
	<body>
		...
		<div data-role="page" id="pgi" >
			...
			<div data-role="header" class="menu">
				...
				<h1>Inak Ingeniaritza - Coeficientes de gastos indirectos</h1>
			...
			<div data-role="content" class="anchocontenidodesktop">
				...
				<div id="ptcabecera">
					<table id="pttablegi">
						<tr>
							<th id="tablecodigo"> AÑO </th>
							<th > COEFICIENTE GASTOS INDIRECTOS </th>
						</tr>
					</table>
					<div data-role="popup" id="popupgastosindirectos"  class="ui-corner-all">
    					<form class="popupwsmenu">
        					<div style="padding:10px 20px;">
            					<h3>COEFICIENTE GASTOS INDIRECTOS</h3>
            					<input type="text" id="modgi" value="" placeholder="Coeficiente gastos indirectos" >
            					<button id="popupgastosindirectosboton" type="button" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-btn-icon-left ui-icon-check">Guardar</button>
        					</div>
    					</form>
					</div>
