$(document).delegate('#phrus', 'pagecreate', function() {
...
/* 		var mesnombre = a;
	...
	var dom = {
		"tablames" : function() {
			...
			$("#tablasmeses").append("<div id=" + mes + " class='borrar'> \
						...
						<tr  class='titulomes borrar'> \
							...
							<th colspan = '3'> HT </th> \
							<th colspan = '3' id=" + mes + "horascalendario class='teoricashoy'> horas </th> \
						</tr> \
						<tr  class='titulomes borrar'> \
							<th colspan = '3'> HR </th> \
							<th colspan = '3' id=" + mes + "horas class='imputadas'> horas </th> \
						</tr> \
						</table> \
					<div> 					");
		...
		"diasemana" : function() {
			...
			domdias = domdias + "<th colspan='3'>" + s + "</th>"
		},
		...
		"vacacionesbaja" : function() {
			...
			if(urte=="2018"){
				horasteoricasurte = horasteoricasurte - 25.52
			};
		...
		"horasfuera" : function() {
			var horasfuera = 0;
			for (i in arrayhoras){
				if (arrayhoras[i].codigo!="A004-13" && arrayhoras[i].fuera=="SI"){
		...
		"horascalendariourtehoy" : function() {
			...
			if (urte=="2018"){
				horascalendariourtehoy=horascalendariourtehoy + 25.52;
			}
